...
lastWord = '';
numOfWords = 0;
funbox = input('What funbox would you like to pick? Choose between normal, wasd, binary, bigram salad, weakspot, nospace, wikipedia, 58008, gibberish and wikipedia tags.')
