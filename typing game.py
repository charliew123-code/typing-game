...
while points >= 0 and points < goal:
    while numOfWords < wordLimit:
        ...
        if funbox == 'nospace' or funbox == 'binary':
            text = text + word;
        elif funbox == '58008' or funbox == 'gibberish':
